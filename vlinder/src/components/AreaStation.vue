...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.width = 400; div.node().getBoundingClientRect()['width'];
            this.height = 200; div.node().getBoundingClientRect()['height'];
        ...
        methods: {
            update_data() {
                ...
                bars.append("rect")
                    ...
                    .on("mouseover", function (d) { showLabel(this, d['usage'][0]['value'], 'water'); })
                ...
                bars.append("rect")
                    ...
                    .attr("fill", "limegreen")
                    .on("mouseover", function (d) { showLabel(this, d['usage'][1]['value'], 'groen'); })
                    .on("mouseout", function () { removeLabel(this); })
                ;
                ...
                bars.append("rect")
                    ...
                    .on("mouseover", function (d) { showLabel(this, d['usage'][2]['value'], 'verhard') })
                    .on("mouseout", function () { removeLabel(this); })
                ;
