<template>
    <div style="height: 100vh; display: flex; flex-flow: column; background-color: #F5F6FA">
        <b-navbar toggleable="lg" type="light" style="background-color: #FFFFFF; box-shadow: 0 0 10px 0 rgba(0,0,0,0.10);">
            ...
            <b-collapse id="nav-collapse" is-nav>
                ...
                <b-navbar-nav class="ml-auto">
                    ...
                    <b-nav-item @click="shown = 'info'" :active="shown === 'info'" v-bind:style="shown === 'info' ? 'border-bottom: 3px solid #6685F7;': ''">
                        Info
                    </b-nav-item>
        ...
        <Dashboard :class="shown === 'dashboard' ? '' : 'disabled'"/>
        ...
        <footer style="text-align: center; width: 100%; color: grey; font-size: small; margin-top: 5vh; background-color: #fff; box-shadow: 0 0 10px 0 rgba(0,0,0,0.10);">
            ...
            <span>© Project Datavisualisatie UGent</span><br/>
            <span>Lucas Belpaire, Sam Coutteau, Flor Delombaerde, Joachim Geers, Tobiah Lissens, Floor Van de Steene</span>
        </footer>
    </div>
</template>
